...
export const Route = createFileRoute("/register")({
  head: () => ({
    meta: [
      { title: "Cadastre-se — RotaExpress" },
      {
        name: "description",
        content: "Crie uma nova conta Prisma Market.",
      },
    ],
  }),
...
const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      // Depois de cadastrar, mandamos o usuário para a tela de login
      navigate({ to: "/login" }); 
    } catch (err: any) {
      // Mostra o erro real que o Supabase/Backend devolveu
    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-12">
      <GlassCard className="w-full max-w-md p-8 sm:p-10">
        ...
        >
          ...
          <span className="font-semibold text-foreground">Prisma Market</span>
        </Link>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Cadastre-se para começar a sincronizar seu carrinho e recomendações pessoais.
        </p>
